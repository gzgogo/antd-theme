export default {
  ...
  '@success-color': '#0acc9d',
  '@info-color': '#313133',
  '@warning-color': '#f59f00',
  '@error-color': '#f64357',
  '@highlight-color': '#f64357',
  '@processing-color': '@blue-6',
  '@body-background': '#0b0e12',
  '@component-background': '#12161d',
  '@icon-color': '#A2B0C6',
  ...
  '@text-color-dark': '#868e96',
  '@text-color-secondary-dark': '#adb5bd',
  '@text-selection-bg': '#4285f4',
  '@border-color-base': '#495057',
  '@border-color-split': '#282e34',
  ...
  '@modal-header-bg': '#20262F ',
  '@modal-footer-bg': '#20262F ',
  '@modal-mask-bg': 'fade(@black, 45%)',
  '@progress-default-color': '@processing-color',
  '@progress-remaining-color': '#20262F',
  '@progress-text-color': '#868E96',
  ...
  '@table-header-bg': '#171D25 ',
  '@table-header-color': '#ADB5BD',
  '@table-header-sort-bg': '@background-color-base',
  '@table-body-sort-bg': 'rgba(0, 0, 0, 0.01)',
  '@table-row-hover-bg': '#1F2530',
  '@table-selected-row-color': 'inherit',
  '@table-selected-row-bg': '#12161d',
  '@table-body-selected-sort-bg': '@table-selected-row-bg',
  '@table-selected-row-hover-bg': '@table-selected-row-bg',
  '@table-expanded-row-bg': '#1f2530',
  '@table-padding-vertical': '16px',
  '@table-padding-horizontal': '16px',
  '@table-border-radius-base': '@border-radius-base',
  '@tag-default-bg': '#20262F',
  '@tag-default-color': '#ADB5BD',
  '@tag-font-size': '@font-size-sm',
  '@time-picker-panel-column-width': '56px',
  '@time-picker-panel-width': '@time-picker-panel-column-width * 3',
  '@time-picker-selected-bg': ' #2B333F',
  ...
  '@card-head-background': '#171D25',
  '@card-head-padding': '16px',
  '@card-inner-head-padding': '12px',
  '@card-padding-base': '24px',
  '@card-actions-background': '@background-color-light',
  '@card-background': '@component-background',
  '@card-shadow': ' 0 2px 8px 0 rgba(0,0,0,0.10)',
  ...
  '@collapse-header-bg': '#171D25',
  '@collapse-content-padding': '@padding-md',
  '@collapse-content-bg': '@component-background',
  '@skeleton-color': '#f2f2f2',
  '@transfer-header-height': '36px',
  '@transfer-disabled-bg': ' #495057',
  '@transfer-list-height': '200px',
  '@message-notice-content-padding': '10px 16px',
  '@wave-animation-width': '6px',
  '@alert-success-border-color': '#20262F ',
  '@alert-success-bg-color': '#20262F',
  '@alert-success-icon-color': '@success-color',
  '@alert-info-border-color': '#20262F ',
  '@alert-info-bg-color': '#20262F ',
  '@alert-info-icon-color': '@info-color',
  '@alert-warning-border-color': '#20262F ',
  '@alert-warning-bg-color': '#20262F ',
  '@alert-warning-icon-color': '@warning-color',
  '@alert-error-border-color': '#20262F ',
  '@alert-error-bg-color': '#20262F ',

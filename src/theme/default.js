export default {
  ...
  '@icon-color': 'inherit',
  '@icon-color-hover': 'rgb(0,0,0,0.75)',
  '@heading-color': 'rgb(0,0,0,0.85)',
  '@text-color': 'rgb(0,0,0,0.65)',
  '@text-color-secondary': 'rgb(0,0,0,0.45)',
  '@text-color-inverse': '#fff',
  '@heading-color-dark': 'rgb(0,0,0,1)',
  '@text-color-dark': 'rgb(255,255,255,0.85)',
  '@text-color-secondary-dark': 'rgb(255,255,255,0.65)',
  ...
  '@layout-footer-padding': '@layout-header-background',
